...
<Frame>
  <img src="/platform/building-agents/images/phone-numbers.png" alt="Phone Numbers page" />
</Frame>
...
<Tabs>
  <Tab title="Rent Number">
    <Frame caption="Rent Number modal">
      ![Rent number](/platform/building-agents/images/rent-number.png)
    </Frame>
  ...
  <Tab title="Import SIP">
    <Frame caption="Import SIP Number modal">
      ![Import SIP number](/platform/building-agents/images/import-sip.png)
    </Frame>
