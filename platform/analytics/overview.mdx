...
The Analytics dashboard gives you a bird's-eye view of all your voice AI activity—call volumes, connection rates, costs, and agent performance.

**Location:** Left Sidebar → Observe → Analytics

<Frame>
  <img src="/platform/building-agents/images/analytics.png" alt="Analytics dashboard" />
</Frame>
